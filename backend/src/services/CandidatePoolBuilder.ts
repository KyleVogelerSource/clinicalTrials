...
import { CandidatePool, CandidatePoolMetadata, ExcludedRecord, FilteredRecord, FilterReason, NormalizedTrial, ReferenceTrial } from "../models/NormalizedTrial";
...
export function buildCandidatePool(studies: ClinicalTrialStudy[], totalPagesFetched: number, config: PoolBuilderConfig = {}): CandidatePool {
    ...
    return { trials, metadata, filtered, excluded };
}
